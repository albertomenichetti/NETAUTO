...
class HarnessPhase(StrEnum):
    ...
    LOCK_PLAN_BUILT = "LOCK_PLAN_BUILT"
    GATE_WAITING = "GATE_WAITING"
    GATE_ACQUIRED = "GATE_ACQUIRED"
    ROW_LOCK_WAITING = "ROW_LOCK_WAITING"
    ROW_LOCKS_ACQUIRED = "ROW_LOCKS_ACQUIRED"
    PROTECTED_STATE_REREAD = "PROTECTED_STATE_REREAD"
    LOCK_PLAN_STALE = "LOCK_PLAN_STALE"
    ...
    CONSTRAINT_ARBITRATED = "CONSTRAINT_ARBITRATED"
    BEFORE_COMMIT = "BEFORE_COMMIT"
    COMMITTED = "COMMITTED"
    ROLLED_BACK = "ROLLED_BACK"
    UOW_RESTARTED = "UOW_RESTARTED"

    # Delivered harness compatibility name. Enum iteration exposes only the
    # canonical M2 vocabulary above, so this remains a thin alias rather than
    # a second phase authority.
    OWNER_STABILIZED = DEPENDENCIES_STABILIZED
