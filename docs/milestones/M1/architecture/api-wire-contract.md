...
**Status:** DRAFT — API-03 in progress. Il `core.byte_size` request/canonical wire contract qui definito è ratificato; le restanti DTO/wire decisioni API-03 non sono ancora congelate.
...
## 2. API-03 pre-flight finding — `core.byte_size`
...
## 3. Ratified `core.byte_size` public wire input
...
### 3.2 Quantity string with explicit SI/IEC unit
...
## 4. Canonical output and persistence
...
## 5. Wire/domain validation boundary
...
## 6. Ratified byte-size wire decisions
